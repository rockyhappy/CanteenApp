...
class PaymentAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.rv_item_seller, parent, false)
...
//        }
    ...
    fun updateDataWithDiffUtil(newDataList: List<Int>) {
        val diffResult = DiffUtil.calculateDiff(PaymentDiffCallback(dataList, newDataList))
        dataList.clear()
        dataList.addAll(newDataList)
