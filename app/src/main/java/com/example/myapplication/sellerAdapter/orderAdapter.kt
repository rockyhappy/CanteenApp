...
class orderAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.rv_order_item, parent, false)
...
//        }
    ...
    fun updateDataWithDiffUtil(newDataList: List<Int>) {
        val diffResult = DiffUtil.calculateDiff(OrderDiffCallback(dataList, newDataList))
        dataList.clear()
        dataList.addAll(newDataList)
