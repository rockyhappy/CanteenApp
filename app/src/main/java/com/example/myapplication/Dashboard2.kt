...
import com.example.myapplication.databinding.ActivityDashboard2Binding
...
class Dashboard2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarDashboard2.fab.setOnClickListener { view ->
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.dashboard2, menu)
        return true
    }
